...
// 		bgPos: (Point)
    ...
    divDom: undefined,
    spanglyphDom: undefined,
    createIcon: function () {
       
        this.divDom = this.divDom || document.createElement('div'),
        ...
        this._setIconStyles(this.divDom, options.className);
		return this.divDom;
	},
	...
	_createGlyph: function() {
		...
		var span = this.spanglyphDom = this.spanglyphDom || L.DomUtil.create('span', options.prefix + ' ' + glyphClass);
	...
	_setIconStyles: function (div, name) {
		...
		//src = L.Icon.Glyph.prototype.options.iconUrl;
		if (src) {
			div.style.backgroundImage = "url('" + src + "')";
		}
		div.style.fontSize = size.y+"px";
...
//L.Icon.Glyph.prototype.options.iconUrl = 'https://unpkg.com/leaflet@1.3.3/dist/images/marker-icon.png';
