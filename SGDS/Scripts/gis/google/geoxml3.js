...
geoXML3.fetchZIP = function (url, callback, parser) {
    //if (url.toUpperCase().lastIndexOf("KMZ") == url.length - 3) { //解決中文碼問題20200730
        if (!window.JSZip && !window.JSZipUtils) {
            alert('尚未引用 jszip.js、jszip-utils.js');
            callback();
            return;
        }
