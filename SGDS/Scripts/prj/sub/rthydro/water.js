(function ($) {
    ...
    pluginclass.prototype = {
        ...
        initUi: function () {
                ...
                setTimeout(function () {
                    ...
                    if (filtercache != _county + "_" + _basin) {
                        ...
                        $pinctrl.WaterCtrl('setFilter', function (d) {
                            return (_basin < 0 ? true : d.BASIN_NO == _basin) && (_county == '-1' ? true : (d.ADDR_C && d.ADDR_C.indexOf(_county)>=0));
                        });
                    }
            ...
            InitWraWater($pinctrl, { pinClick: function (d) { that.$element.trigger('pin-click', [d]); } });
        }
    }
